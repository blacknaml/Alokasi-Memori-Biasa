...
int main(int argc, char *argv[])
{
    ...
    objMhs1 = new Mahasiswa("223334445555");
    objMhs2 = new Mahasiswa("11222333444");
    objMhs3 = new Mahasiswa("111222333333");

    cout << objMhs1->nim() << " : " << objMhs1->getNimLength() << " kar" << endl;
    objMhs1->setNim(objMhs2->nim());
    objMhs2->setNim(objMhs3->nim());
    cout << objMhs1->nim() << " : " << objMhs1->getNimLength() << " kar" << endl;
    cout << objMhs2->nim() << " : " << objMhs1->getNimLength() << " kar" << endl;
    cout << objMhs3->nim() << " : " << objMhs1->getNimLength() << " kar" << endl;
